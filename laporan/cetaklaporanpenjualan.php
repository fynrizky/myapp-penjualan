...
if (isset($_GET['tgl1']) && isset($_GET['tgl2'])) {
	$dat = $cetaklaporan->laporan_penjualan_bulan($koneksi,$_GET['tgl1'],$_GET['tgl2']);
}else{
	$dat = $cetaklaporan->laporan_semua_penjualan($koneksi);
}
...
$pemilik = $per['pemilik'];
// $kota = $per['kota'];
$judul_H = "CETAK LAPORAN PENJUALAN <br>";
$tgl = date('d-m-Y');
