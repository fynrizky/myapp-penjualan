            ...
            <!-- Row -->
                <div class="row">
                    ...
                    <div class="card-heading" align="center">
                        ...
                        <a href="laporan/cetaklaporanpenjualan.php?tgl1=<?php echo $_POST['tgl1']; ?>&tgl2=<?php echo $_POST['tgl2']; ?>" target="_BLANK" class="btn btn-info btn-sm"><i class="fa fa-print"></i> Cetak</a>
                        <?php endif ?>
                        <?php if (isset($_POST['semua'])): ?>
                        <a href="laporan/cetaklaporanpenjualan.php?semua" target="_BLANK" class="btn btn-info btn-sm"><i class="fa fa-print"></i> Cetak</a>
                        <?php endif ?>
					...
					<?php  
						if (isset($_POST['prosess'])) {
							$total = $laporan->hitung_total_penjualan_bulan($koneksi,$_POST['tgl1'],$_POST['tgl2']);
							$cek = $laporan->cek_penjualan_bulan($koneksi,$_POST['tgl1'],$_POST['tgl2']);
							if ($cek === false) {
								false;
							}
							else{
							$lapbl = $laporan->tampil_penjualan_bulan($koneksi,$_POST['tgl1'],$_POST['tgl2']);
					...
					<?php
						...
						elseif (isset($_POST['semua'])) {
							...
							$cek = $laporan->cek_penjualan($koneksi);
							if ($cek === false) {
								false;
							}
							else{
							$lap = $laporan->tampil_penjualan($koneksi);
