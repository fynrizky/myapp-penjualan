        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="69%" rowspan="3" valign="top" class="style19b">
              ...
              <br />
              <p class="par" style="width: 400px; font-size: 12px; margin-top: -20px; margin-left: 100px; font-weight: italic;"><?php echo $per['alamat']; ?></p>
            </td>
            <td colspan="3">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="24" class="style6">
      <div align="center">No</div>
    </td>
    <td width="150" class="style6">
      <div align="left">Id Barang Pembelian</div>
    </td>
    <td width="203" class="style6">
      <div align="left">Nama Barang</div>
    </td>
    <td width="60" class="style6">
      <div align="left">Satuan</div>
    </td>
    <td width="94" class="style6">
      <div align="left">Jumlah</div>
    </td>
    <td width="117" class="style6">
...
<table width="98%" border="0" align="center">
  ...
  <tr>
    <td colspan="3">
      <div align="center" class="style9"><?php echo ucwords($tam['nama_user']); ?></div>
    </td>
    <td colspan="3">&nbsp;</td>
    <td colspan="3"></td>
  </tr>
